...
CNRM_85 = pd.read_csv(f'/{file_path}/Uncertainty Analysis/SSP2/SSP2_Climate/WaSSI_CNRMCM5_RCP85.TXT')
HadGEM2_85 = pd.read_csv(f'/{file_path}/Uncertainty Analysis/SSP2/SSP2_Climate/WaSSI_HadGEM2ES365_RCP85.TXT')
IPSL_85 = pd.read_csv(f'/{file_path}/Uncertainty Analysis/SSP2/SSP2_Climate/WaSSI_IPSLCM5AMR_RCP85.TXT')
CGCM3_85 = pd.read_csv(f'/{file_path}/Uncertainty Analysis/SSP2/SSP2_Climate/WaSSI_MRICGCM3_RCP85.TXT')
NORESM_85 = pd.read_csv(f'/{file_path}/Uncertainty Analysis/SSP2/SSP2_Climate/WaSSI_NORESM1M_RCP85.TXT')

#%%

## loading huc8 values for proposed mines

proposed_mines_huc8 = pd.read_csv(f'/{file_path}/Uncertainty Analysis/SSP2/proposed_mines_huc8.csv')
...
CNRM_85_uncertainty_values_triangular = pd.read_csv(f'/{file_path}/Uncertainty Analysis/SSP2/SSP2_Climate/CNRM_85_uncertainty_values_triangular.csv')
HadGEM2_85_uncertainty_values_triangular = pd.read_csv(f'/{file_path}/Uncertainty Analysis/SSP2/SSP2_Climate/HadGEM2_85_uncertainty_values_triangular.csv')
IPSL_85_uncertainty_values_triangular = pd.read_csv(f'/{file_path}/Uncertainty Analysis/SSP2/SSP2_Climate/IPSL_85_uncertainty_values_triangular.csv')
CGCM3_85_uncertainty_values_triangular = pd.read_csv(f'/{file_path}/Uncertainty Analysis/SSP2/SSP2_Climate/CGCM3_85_uncertainty_values_triangular.csv')
NORESM_85_uncertainty_values_triangular = pd.read_csv(f'/{file_path}/Uncertainty Analysis/SSP2/SSP2_Climate/NORESM_85_uncertainty_values_triangular.csv')
...
if runclimate == True:
    ...
    ## saving into csvs
        ...
        filepath = ff'/{file_path}/Uncertainty Analysis/SSP2/SSP2_Climate/{filename}'
